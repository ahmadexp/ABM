...
//scratch that its fine when only rotating around the y axis
...
void spherebumpmesh(
	...
	int BEHIND = 0; // This is returned if the sphere is completely behind the plane
	int INTERSECTS = 1; // This is returned if the sphere intersects the plane
	int FRONT = 2; // This is returned if the sphere is completely in front of the plane
